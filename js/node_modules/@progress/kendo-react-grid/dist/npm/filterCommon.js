 ...
 * @hidden
 */
exports.cellBoolDropdownChange = function (event, onChange) {
    var item = event.target.value;
    onChange({
        value: item.operator,
        operator: item.operator === '' ? '' : exports.defaultBooleanOperator,
 ...
 * @hidden
 */
exports.cellOperatorChange = function (event, currentValue, onChange) {
