...
var messages = {
    ...
    warnings: {
        // deprecated methods
        enableDeprecation: 'Torus: ""ethereum.enable()" is deprecated and may be removed in the future. ' +
            'Please use "ethereum.send("eth_requestAccounts")" instead. For more information, see: https://eips.ethereum.org/EIPS/eip-1102',
        sendDeprecation: 'Torus: "ethereum.send(...)" is deprecated and may be removed in the future.' +
        ...
        events: {
            close: 'Torus: The event "close" is deprecated and may be removed in the future. Please use "disconnect" instead.' +
                "\nFor more information, see: https://eips.ethereum.org/EIPS/eip-1193",
            data: 'Torus: The event "data" is deprecated and will be removed in the future.' +
                'Use "message" instead.\nFor more information, see: https://eips.ethereum.org/EIPS/eip-1193#message',
            networkChanged: 'Torus: The event "networkChanged" is deprecated and may be removed in the future.' +
                ' Please use "chainChanged" instead.\nFor more information, see: https://eips.ethereum.org/EIPS/eip-1193',
            notification: 'Torus: The event "notification" is deprecated and may be removed in the future. ' +
    ...
    try {
        if ((buildEnv === "binance" || buildEnv === "production") && !integrity.version) {
            ...
            if (!configuration.prodTorusUrl)
                response = yield get(`${configuration.api}/latestversion?name=@toruslabs/torus-embed&version=${version}`, {}, { useAPIKey: true });
            else
                response = { data: configuration.prodTorusUrl };
...
class TorusInpageProvider extends SafeEventEmitter {
    constructor(connectionStream, { maxEventListeners = 100, shouldSendMetadata = true, jsonRpcStreamName = "provider" } = {}) {
        super();
        this._sentWarnings = {
            // methods
            enable: false,
    ...
    _initializeState() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { accounts, chainId, isUnlocked, networkVersion } = (yield this.request({
...
(function preLoadIframe() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { torusUrl } = yield getTorusUrl("production", { check: false, hash: iframeIntegrity, version: "" });
...
class Torus {
    ...
    init({ buildEnv = TORUS_BUILD_ENV.PRODUCTION, enableLogging = false, 
    ...
    enabledVerifiers = defaultVerifiers, network = {
        ...
        version: "",
    }, whiteLabel, skipTKey = false, useLocalStorage = false, } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isInitialized)
                throw new Error("Already initialized");
            const { torusUrl, logLevel } = yield getTorusUrl(buildEnv, integrity);
      ...
      ></iframe>`);
            ...
            if (buildEnv === "production" && integrity.check) {
                ...
                const resp = yield fetch(fetchUrl, { cache: "reload" });
    ...
    setProvider(_a = {}) {
        var { host = "mainnet", chainId = null, networkName = "" } = _a, rest = __rest(_a, ["host", "chainId", "networkName"]);
        return new Promise((resolve, reject) => {
    ...
    getPublicAddress({ verifier, verifierId, isExtended = false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const existingV1User = yield this.torusJs.getUserTypeAndAddress(endpoints, torusNodePubs, { verifier: walletVerifier, verifierId });
                ...
                const v2User = yield this.torusJs.getUserTypeAndAddress(endpoints, torusNodePubs, { verifier: openloginVerifier, verifierId }, true);
                if (!isExtended)
                ...
                if (error === null || error === void 0 ? void 0 : error.message.includes("Verifier + VerifierID has not yet been assigned")) {
                    ...
                    const newV2User = yield this.torusJs.getUserTypeAndAddress(endpoints, torusNodePubs, { verifier: openloginVerifier, verifierId }, true);
                    if (!isExtended)
