...
var ExpressAppRunner_1 = require("./ExpressAppRunner");
...
var NodeRunner = /** @class */ (function () {
    function NodeRunner(arweaveService, providerAddress, nodeConfig, initialManifest) {
        ...
        this.httpBroadcaster = new broadcasters_1.HttpBroadcaster(nodeConfig.httpBroadcasterURLs);
        this.streamrBroadcaster = new broadcasters_1.StreamrBroadcaster(nodeConfig.credentials.ethereumPrivateKey);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        new ExpressAppRunner_1.ExpressAppRunner().run();
                    ...
                    case 8:
                        manifestData = (0, objects_1.readJSON)(nodeConfig.manifestFile);
                        _a.label = 9;
    ...
    NodeRunner.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger.info("Running redstone-node with manifest:\n      ".concat(JSON.stringify(this.currentManifest), "\n      Version: ").concat(this.version, "\n      Address: ").concat(this.providerAddress, "\n    "));
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        (0, performance_tracker_1.printTrackingState)();
                        return [2 /*return*/];
                }
            });
        });
    ...
    NodeRunner.prototype.safeProcessManifestTokens = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        processingAllTrackingId = (0, performance_tracker_1.trackStart)("processing-all");
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        (0, performance_tracker_1.trackEnd)(processingAllTrackingId);
                        return [7 /*endfinally*/];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    NodeRunner.prototype.warnIfARBalanceLow = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        balanceCheckingTrackingId = (0, performance_tracker_1.trackStart)("balance-checking");
                        _b.label = 1;
                    case 1:
                    ...
                    case 2:
                        ...
                        if (isBalanceLow) {
                            logger.warn("AR balance is quite low: ".concat(balance));
                        }
                        return [3 /*break*/, 5];
                    case 3:
                        e_4 = _b.sent();
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        (0, performance_tracker_1.trackEnd)(balanceCheckingTrackingId);
                        return [7 /*endfinally*/];
                    case 5: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.arweaveService.prepareArweaveTransaction(aggregatedPrices, this.version, this.nodeConfig.omitSourcesInArweaveTx)];
                    case 2:
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 8];
                    case 7:
                        logger.info("Transaction posting skipped in non-prod env: ".concat(arTransaction.id));
                        _a.label = 8;
    ...
    NodeRunner.prototype.fetchPrices = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fetchingAllTrackingId = (0, performance_tracker_1.trackStart)("fetching-all");
                        fetchTimestamp = Date.now();
                        return [4 /*yield*/, this.pricesService.fetchInParallel(this.tokensBySource)];
                    case 1:
                        fetchedPrices = _a.sent();
                        pricesData = (0, objects_1.mergeObjects)(fetchedPrices);
                        ...
                        (0, performance_tracker_1.trackEnd)(fetchingAllTrackingId);
    ...
    NodeRunner.prototype.broadcastPrices = function (signedPrices) {
        return __awaiter(this, void 0, void 0, function () {
            var broadcastingTrackingId, promises, e_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger.info("Broadcasting prices");
                        broadcastingTrackingId = (0, performance_tracker_1.trackStart)("broadcasting");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        promises = [];
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        (0, performance_tracker_1.trackEnd)(broadcastingTrackingId);
                        return [7 /*endfinally*/];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    NodeRunner.printAggregatedPrices = function (prices) {
        for (var _i = 0, prices_1 = prices; _i < prices_1.length; _i++) {
            ...
            logger.info("Fetched price : ".concat(price.symbol, " : ").concat(price.value, " | ").concat(sourcesData));
        }
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        packageBroadcastingTrackingId = (0, performance_tracker_1.trackStart)("package-broadcasting");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        (0, performance_tracker_1.trackEnd)(packageBroadcastingTrackingId);
                        return [7 /*endfinally*/];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    NodeRunner.prototype.broadcastSignedPricePackage = function (signedPackage) {
        return __awaiter(this, void 0, void 0, function () {
            var signedPackageBroadcastingTrackingId, promises, e_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        signedPackageBroadcastingTrackingId = (0, performance_tracker_1.trackStart)("signed-package-broadcasting");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        promises = [];
                        promises.push(this.httpBroadcaster.broadcastPricePackage(signedPackage, this.providerAddress));
                        if (this.nodeConfig.enableStreamrBroadcaster) {
                            promises.push(this.streamrBroadcaster.broadcastPricePackage(signedPackage, this.providerAddress));
                        }
                        return [4 /*yield*/, Promise.all(promises)];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        (0, performance_tracker_1.trackEnd)(signedPackageBroadcastingTrackingId);
                        return [7 /*endfinally*/];
                    case 5: return [2 /*return*/];
                }
            });
    ...
    NodeRunner.prototype.maybeLoadManifestFromSmartContract = function () {
        ...
        if (timeDiff >= exports.MANIFEST_REFRESH_INTERVAL) {
            ...
            var manifestFetchTrackingId_1 = (0, performance_tracker_1.trackStart)("Fetching manifest.");
            try {
                ...
                Promise.race([
                    ...
                    (0, objects_1.timeout)(MANIFEST_LOAD_TIMEOUT_MS)
                ]).then(function (value) {
                    if (value === "timeout") {
                    ...
                    (0, performance_tracker_1.trackEnd)(manifestFetchTrackingId_1);
                });
            }
            catch (e) {
