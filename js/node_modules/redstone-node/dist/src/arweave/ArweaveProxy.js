    ...
    function ArweaveProxy(jwk) {
        ...
        this.arweave = arweave_multihost_1.default.initWithDefaultHosts({
            ...
            onError: function () {
                ...
                logger.warn.apply(logger, __spreadArray(["Arweave request failed"], args, false));
            },
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        logger.info("".concat(uploader.pctComplete, "% complete, ").concat(uploader.uploadedChunks, "/").concat(uploader.totalChunks));
                        return [3 /*break*/, 2];
