...
var ArweaveService = /** @class */ (function () {
    ...
    ArweaveService.prototype.prepareArweaveTransaction = function (prices, nodeVersion, omitSources) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionPreparingTrackingId, tags, pricesToAttachInArweaveTx, transaction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transactionPreparingTrackingId = (0, performance_tracker_1.trackStart)("transaction-preparing");
                        ...
                        pricesToAttachInArweaveTx = __spreadArray([], prices, true);
                        if (omitSources) {
                            pricesToAttachInArweaveTx = prices.map(function (price) {
                                price.source = {};
                                return price;
                            });
                        }
                        return [4 /*yield*/, this.arweaveProxy.prepareUploadTransaction(tags, pricesToAttachInArweaveTx)];
                    case 1:
                        transaction = _a.sent();
                        (0, performance_tracker_1.trackEnd)(transactionPreparingTrackingId);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        logger.info("Balance: ".concat(balance));
    ...
    ArweaveService.prototype.storePricesOnArweave = function (arTransaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger.info("Keeping prices on arweave blockchain - posting transaction\n       ".concat(arTransaction.id));
                        keepingTrackingId = (0, performance_tracker_1.trackStart)("keeping");
                        _a.label = 1;
                    case 1:
                    ...
                    case 2:
                        _a.sent();
                        logger.info("Transaction posted: ".concat(arTransaction.id));
                        return [3 /*break*/, 5];
                    case 3:
                        e_2 = _a.sent();
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        (0, performance_tracker_1.trackEnd)(keepingTrackingId);
                        return [7 /*endfinally*/];
    ...
    ArweaveService.prototype.checkAllPricesHaveSameTimestamp = function (prices) {
        ...
        if (differentTimestamps.size !== 1) {
            throw new Error("All prices should have same timestamps.\n     Found ".concat(differentTimestamps.size, " different timestamps."));
        }
    };
