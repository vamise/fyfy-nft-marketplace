...
var PricesService = /** @class */ (function () {
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (e_1.name == "ManifestConfigError") {
                            ...
                            logger.warn("Fetching failed for source: ".concat(source, ": ").concat(resData), e_1.stack);
                            return [2 /*return*/, (_b = {},
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (tokens.length === 0) {
                            throw new ManifestConfigError_1.default("".concat(source, " fetcher received an empty array of symbols"));
                        }
                        ...
                        if (sourceTimeout === null) {
                            throw new ManifestConfigError_1.default("No timeout configured for ".concat(source, ". Did you forget to add \"sourceTimeout\" field in manifest file?"));
                        }
                        logger.info("Call to ".concat(source, " will timeout after ").concat(sourceTimeout, "ms"));
                        trackingId = (0, performance_tracker_1.trackStart)("fetching-".concat(source));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, , 3, 4]);
                        return [4 /*yield*/, (0, promise_timeout_1.timeout)(fetchPromise, sourceTimeout)];
                    case 2:
                        prices = _a.sent();
                        logger.info("Fetched prices in USD for ".concat(prices.length, " ")
                            + "currencies from source: \"".concat(source, "\""));
                        return [2 /*return*/, prices];
                    case 3:
                        (0, performance_tracker_1.trackEnd)(trackingId);
                        return [7 /*endfinally*/];
    ...
    PricesService.prototype.maxPriceDeviationPercent = function (priceSymbol) {
        ...
        if (result === null) {
            throw new ManifestConfigError_1.default("Could not determine maxPriceDeviationPercent for ".concat(priceSymbol, ".\n        Did you forget to add maxPriceDeviationPercent parameter in the manifest file?"));
        }
        logger.debug("maxPriceDeviationPercent for ".concat(priceSymbol, ": ").concat(result));
        return result;
    };
