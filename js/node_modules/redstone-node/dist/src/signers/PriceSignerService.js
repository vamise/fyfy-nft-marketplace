    ...
    PriceSignerService.prototype.signPrices = function (prices) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        signingTrackingId = (0, performance_tracker_1.trackStart)("signing");
                        signedPrices = [];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, , 6, 7]);
                    ...
                    case 2:
                        ...
                        price = prices_1[_i];
                        logger.info("Signing price: ".concat(price.id));
                    ...
                    case 6:
                        (0, performance_tracker_1.trackEnd)(signingTrackingId);
                        return [7 /*endfinally*/];
    ...
    PriceSignerService.prototype.signSinglePrice = function (price) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger.info("Signing price with arweave signer: ".concat(price.id));
                        return [4 /*yield*/, this.arweaveService.signPrice(price)];
                    case 1:
                        signedPrice = _a.sent();
                        if (this.addEvmSignature) {
                            logger.info("Signing price with evm signer: ".concat(price.id));
