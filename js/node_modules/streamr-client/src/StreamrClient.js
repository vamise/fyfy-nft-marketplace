...
class StreamrClient extends eventemitter3_1.default {
    ...
    getDataUnion(mainnetAddress, sidechainAddress) {
        if (!sidechainAddress) {
            ...
            return new DataUnion_1.DataUnion(mainnetAddress, calculatedSidechainAddress, this);
        }
    ...
    async safeGetDataUnion(contractAddress) {
        ...
        const version = await DataUnion_1.DataUnion.getVersion(this.ethereum.getMainnetProvider(), contractAddress);
        if (version === 1) {
    ...
    _getDataUnionFromName({ dataUnionName, deployerAddress }) {
        ...
        return new DataUnion_1.DataUnion(mainnetAddressPredicted, sidechainAddressPredicted, this);
    }
    /**
     * @category Important
     */
