...
function maticSign(message) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const signer = new signing_1.PolygonSigner(index_1.currencies["matic"].account.key);
        return signer.sign(message);
    });
}
exports.maticSign = maticSign;
function maticGetSigner() {
    return new signing_1.PolygonSigner(index_1.currencies["matic"].account.key);
}
exports.maticGetSigner = maticGetSigner;
function maticVerify(pub, data, sig) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        return signing_1.PolygonSigner.verify(pub, data, sig);
    });
}
