...
const AppBar = (props) => {
    ...
    const TopBar = (react_1.default.createElement("div", { className: "App-Bar-right" },
        props.left,
        connected ? (react_1.default.createElement(CurrentUserBadge_1.CurrentUserBadge, null)) : (react_1.default.createElement(__1.ConnectButton, { type: "text", size: "large", style: { color: '#338ee8' }, allowWalletChange: true })),
